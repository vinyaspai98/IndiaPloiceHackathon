...
# ele.clear()
# ele = driver.find_element_by_xpath("//button[@class='_585_']")
# ele = driver.find_element_by_class_name("_585_")
# ele.send_keys(Keys.ENTER)
# ele.click()
...
# print(overview)
print('https://www.facebook.com/rushirushirushi/about')
for k in overview:
    # span = k.find_all('span')
    print(k.get_text())
    # print('###########')

driver.get('https://www.facebook.com/rushirushirushi/about?section=education')
src = driver.page_source
about_src = bs4.BeautifulSoup(src, 'lxml')

overview2 = about_src.select('._42ef')
# print(overview)
# print('https://www.facebook.com/rushirushirushi/about')
for k in overview2:
    # span = k.find_all('span')
